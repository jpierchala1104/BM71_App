package com.example.bm71_app.fragments;
...
import com.example.bm71_app.MainActivity;
import com.example.bm71_app.R;
...
public class DevicesFragment extends ListFragment {
    ...
    public void startScan() {
        ...
        try{
            ...
            Log.e("Bluetooth Scan", ex.toString());
        }
    ...
    private void updateScan(BluetoothDevice device) {
        ...
        if(!listItems.contains(device)) {
            ...
            Collections.sort(listItems, com.example.bm71_app.fragments.DevicesFragment::compareTo);
            listAdapter.notifyDataSetChanged();

            try {
                if(device.getName().equals("BM71_BLE")){
                    connectWithBM71(device);
                }
            }catch(Exception ex){
                Log.e("Device search", ex.toString());
            }
        }
    }
    ...
    public void onListItemClick(@NonNull ListView l, @NonNull View v, int position, long id) {
        ...
        getFragmentManager().beginTransaction().add(R.id.fragment, fragment, "terminal").commitNow();
        ((MainActivity)getActivity()).onFragReplace();
    }

    public void connectWithBM71(BluetoothDevice device){
        stopScan();
        Bundle args = new Bundle();
        args.putString("device", device.getAddress());
        Fragment fragment = new TerminalFragment();
